...
function PublishedArticle({ article, progress, client, showFallbackNotice = false, sources, selectedSourceNumber, onSelectSource, audioDock, scrollAreaRef }: PublishedArticleProps) {
  ...
  return (
    <article ref={articleRef} data-reading-target={readingId} data-reading-focused={reading.isFocused} className="teaching-article mt-7" aria-label={normalizeDvarTorahText(article.title)}>
      ...
      <header>
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div role="group" aria-label="Teaching actions" className="teaching-actions readable-menu reading-nonessential">
            <TeachingReadButton progress={progress} weekKey={article.week.weekKey} title={title} />
      ...
      <div className="reading-content teaching-body mt-8 max-w-[60rem] space-y-6 border-l-2 border-brass/55 pl-5 sm:pl-7">
      ...
      <p className="mt-10 max-w-[60rem] border-t border-line pt-5 text-xs leading-5 text-muted">
