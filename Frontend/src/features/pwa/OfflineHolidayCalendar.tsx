...
import { selectCalendarEvents } from '../calendar/calendarAgenda.ts'
...
export function OfflineHolidayCalendar() {
  ...
  return <div>
    ...
    {saved ? <>
      ...
      <HolidayAgenda days={days} onRange={setDays} filters={filters} onFilters={setFilters} events={selectCalendarEvents(saved.events, today, days, filters)} />
