...
export const SettingsRegistry: readonly SettingDefinition[] = [
  ...
  { id: 'focused-reading', section: 'reading', label: 'Focused reading view', description: 'Open long answers and teachings in a distraction-free column by default.', keywords: 'focus hide sidebar long content distraction accessibility' },
