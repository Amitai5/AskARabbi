...
describe('Jewish Calendar', () => {
  ...
  it('loads 90 days, focuses the heading, isolates Hebrew and expands all holiday days', async () => {
    ...
    expect(HTMLElement.prototype.scrollTo).toHaveBeenCalledWith(expect.objectContaining({ behavior: 'auto' }))
    expect(screen.getByRole('heading', { name: 'Rosh Hashanah', level: 3 }).closest('summary')).toHaveFocus()
  ...
  it('uses 90/180/360 days and hides all six enabled filters behind an accessible icon', async () => {
    ...
    await waitFor(() => expect(client.getOverview).toHaveBeenLastCalledWith(180, expect.any(AbortSignal)))
    ...
    await waitFor(() => expect(client.getOverview).toHaveBeenLastCalledWith(360, expect.any(AbortSignal)))
  })
