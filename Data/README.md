...
The SQLite file is reproducible and intentionally excluded from Git together with raw JSON and normalized Markdown. Rebuild it after downloading, normalizing, or regenerating the manifest. Supplemental documents are included automatically, and their work-level usage limitations are returned to the AI with each retrieved passage.
