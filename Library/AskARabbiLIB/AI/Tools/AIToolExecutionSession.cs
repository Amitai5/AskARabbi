...
public sealed class AIToolExecutionSession
{
    ...
    private static EvidenceItem CreateEvidence(string evidenceId, string toolName, AIToolEvidence evidence)
    {
        ...
        var source = new SourceSegment
        {
            ...
            Title = "AskARabbi Hebrew calendar calculation",
            HebrewTitle = "חישוב לוח שנה עברי",
            Language = "English",
            LanguageCode = "en",
            Collection = "Calendar calculations",
            Categories = ["Calendar"],
            Version = "AskARabbi deterministic calendar tools v1",
            ...
            UsageNote = "Calculated locally with .NET HebrewCalendar and the pinned Zmanim 1.5.0 calendar tables; not a source text or halakhic ruling.",
