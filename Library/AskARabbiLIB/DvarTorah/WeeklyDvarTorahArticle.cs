...
public sealed record WeeklyDvarTorahArticle
{
    ...
    public WeeklyDvarTorahArticle(WeeklyDvarTorahWeek week, string title, string body, string generatorVersion, DateTimeOffset generatedAtUtc, DateTimeOffset publishedAtUtc)
    {
        ArgumentNullException.ThrowIfNull(week);
        var draft = new WeeklyDvarTorahDraft(title, body, generatorVersion);
