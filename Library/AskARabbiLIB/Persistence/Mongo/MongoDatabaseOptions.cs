...
public sealed class MongoDatabaseOptions
{
    ...
    /// <summary>Gets an optional admission-ledger collection override; null reuses the existing conversation-settings collection.</summary>
    public string? RegistrationCollectionName { get; init; }
    ...
    public void Validate()
    {
        ...
        if (RegistrationCollectionName is not null)
        {
