...
| AI provider | Azure OpenAI Responses API through `IAIEngine` | Strict structured output from an approved source packet; production uses the Container App's Entra identity and the prototype supports a local API key |
